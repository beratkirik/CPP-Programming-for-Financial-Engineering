...
{
    return CallPrice(data.T, data.K, data.sig, data.r, data.b, S);
}
...
{
    return CallPutGamma(data.T, data.K, data.sig, data.r, data.b, S);
}
...
{
    return CallPutGamma(data.T, data.K, data.sig, data.r, data.b, S, h);
}
...
{
    return CallDelta(data.T, data.K, data.sig, data.r, data.b, S);
}
...
{
    return CallDelta(data.T, data.K, data.sig, data.r, data.b, S, h);
}
...
{
    return PutDelta(data.T, data.K, data.sig, data.r, data.b, S);
}
...
{
    return PutDelta(data.T, data.K, data.sig, data.r, data.b, S, h);
}
