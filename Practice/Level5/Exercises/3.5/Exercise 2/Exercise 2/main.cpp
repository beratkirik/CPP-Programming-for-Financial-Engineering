...
int main()
{
    ...
    cout<<sp->ToString()<<endl;        // What is printed? ID and Point p.
    cout<<sp->Shape::ToString()<<endl; /* ID. "To make the compiler generate the required code to find out
                                          what type of object the Shape* variable is actually pointing
                                          to so it can call the right version; we need to declare the
                                          function as virtual." */
