...
//
//  Sample code to show the use of function pointer syntax to promte
...
{ // x = F(x), this is a contraction
    ...
    // Solvers x^3 +2x^2 + 10x = 20 by rewriting in the form x = f(x)
...
int main()
{
    cout << "Cosine fixed point solver: " << FPSolver(cos, 0.12, 1.0e-2) << endl; // 'cos' is system deliverded function
